...
/*    static final String FIELD_FK_CONTACT = "contact";
    static final String FIELD_FK_CONTACT_PRIORITY_TYPE = "contactPriorityType";
    static final String FIELD_FK_CONTACT_TYPE = "contactType";*/
    ...
    static final String DATA_STRING = "DATA_STRING";
    static final String DATA_DATE = "DATA_DATE";
    static final String DATA_DATETIME = "DATA_DATETIME";
    static final String DATA_TIMESTAMP = "DATA_TIMESTAMP";
    static final String DATA_TIME = "DATA_TIME";

    // UnitType
    static final String UNIT_DISTANCE_M = "UNIT_DISTANCE_M";
    static final String UNIT_DISTANCE_KM = "UNIT_DISTANCE_KM";
    static final String UNIT_TIME_S = "UNIT_TIME_S";
    static final String UNIT_TIME_MI = "UNIT_TIME_MI";
    static final String UNIT_TIME_H = "UNIT_TIME_H";
    static final String UNIT_TIME_D = "UNIT_TIME_D";
    static final String UNIT_TIME_MO = "UNIT_TIME_MO";

    // FormatType
    static final String FORMAT_DOUBLE_DOT = "FORMAT_DOUBLE_DOT";
    static final String FORMAT_DATE_yyyyMMdd = "FORMAT_DATE_yyyyMMdd";
    static final String FORMAT_DATETIME_yyyyMMddHHmmss = "FORMAT_DATETIME_yyyyMMddHHmmss";

    // DataUnitFormat
    static final String DATA_INFO_METRE = "DATA_INFO_METRE";

    // Configuration
    static final String CONFIG_ENTER_LOC_RADIUS = "CONFIG_ENTER_LOC_RADIUS";
    static final String CONFIG_MAIL_SERVER_HOST = "CONFIG_MAIL_SERVER_HOST";
    static final String CONFIG_MAIL_SENDER = "CONFIG_MAIL_SENDER";
    static final String CONFIG_MAIL_SENDER_PWD = "CONFIG_MAIL_SENDER_PWD";

    // ContactType
    static final String CONTACT_NORMAL = "CONTACT_NORMAL";
    static final String CONTACT_LEAD = "CONTACT_LEAD";
    static final String CONTACT_MONITOR = "CONTACT_MONITOR";
    static final String CONTACT_CUSTOMER = "CONTACT_CUSTOMER";

    // ContactPriorityType
    static final String CONTACT_PRIORITY_NONE = "CONTACT_PRIORITY_NONE";
    static final String CONTACT_PRIORITY_LOW = "CONTACT_PRIORITY_LOW";
    static final String CONTACT_PRIORITY_MEDIUM = "CONTACT_PRIORITY_MEDIUM";
    static final String CONTACT_PRIORITY_HIGH = "CONTACT_PRIORITY_HIGH";

    // AccountTeamLinkType
    static final String ACC_TEAM_LINK_COLLECTER = "ACC_TEAM_LINK_COLLECTER";
    static final String ACC_TEAM_LINK_ADMIN = "ACC_TEAM_LINK_ADMIN";
    static final String ACC_TEAM_LINK_SUPER_ADMIN = "ACC_TEAM_LINK_SUPER_ADMIN";
