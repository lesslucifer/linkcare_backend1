...
DELIMITER $$
USE cliniccore_db$$
CREATE DEFINER=root@localhost FUNCTION GeoDistDiff(type ENUM('mi', 'km'), lat1 DECIMAL(30,15), lon1 DECIMAL(30,15), lat2 DECIMAL(30,15), lon2 DECIMAL(30,15) ) RETURNS decimal(30,15)
BEGIN
