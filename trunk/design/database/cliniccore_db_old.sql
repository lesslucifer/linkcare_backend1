...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 02, 2016 at 03:21 AM
...
CREATE TABLE IF NOT EXISTS `account_block_time` (
  ...
  `end` datetime GENERATED ALWAYS AS (begin + 60 * length) VIRTUAL,
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `account_id` (`account_id`) USING BTREE,
  KEY `account_block_time_index_begin_end` (`account_id`,`begin`,`end`) USING BTREE
...
CREATE TABLE IF NOT EXISTS `appointment_booking` (
  ...
  `end` smallint(6) GENERATED ALWAYS AS (time + duration) VIRTUAL,
  ...
  KEY `index_date_time` (`medicar`,`date`,`time`,`end`,`status`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=latin1;
...
INSERT INTO `appointment_booking` (`id`, `booker`, `medicar`, `cost`, `home`, `address_id`, `date`, `time`, `duration`, `end`, `status`) VALUES
(2, 1, 1, '1000', 1, 1, '2016-03-30', 480, 30, 510, 1),
(3, 1, 1, '1000', 1, 1, '2016-03-30', 480, 30, 510, 0),
(9, 1, 1, '1000', 1, 1, '2016-03-30', 480, 30, 510, 0),
(10, 1, 1, '1000', 1, 1, '2016-03-30', 480, 30, 510, 0),
(11, 1, 1, '1000', 1, 1, '2016-03-30', 480, 30, 510, 0);
...
CREATE TABLE IF NOT EXISTS `custom_timings` (
  ...
  `end` smallint(6) GENERATED ALWAYS AS (begin + length) VIRTUAL,
  `type` tinyint(4) NOT NULL,
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `index_account_id` (`account_id`),
  KEY `index_type` (`type`),
  KEY `index_date` (`date`,`begin`,`end`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
