...
CREATE TABLE `rate` (
  ...
  CONSTRAINT `FK_l3rl9odf1q3lfmc6hcd6keda9` FOREIGN KEY (`medicar_id`) REFERENCES `account` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `session_log` VALUES (47,'4dadd9bf-5ddc-4820-96e0-60db18925fc8',1460269546777,NULL,1460270746777,1,0,1460269637004,1,1,1460269546777);
...
-- Dump completed on 2016-04-10 13:30:27
